...
@chat.get("/preview_link")
async def get_preview_link(dataset_id,document_id,document_name,current_user: User = Depends(get_required_user)):
    return await ragflow_preview_link(dataset_id,document_id,document_name)
